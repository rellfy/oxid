...
pub struct DrawContext {
    ...
    pub(crate) current_pass: Option<oxid::RenderPass>,
}

impl DrawContext {
    pub fn new(ctx: &mut oxid::Context) -> DrawContext {
    ...
    pub(crate) fn perform_render_passes(&mut self, ctx: &mut oxid::Context) {
        self.gl.draw(ctx);
    }

    pub(crate) fn update_projection_matrix(&mut self, ctx: &mut oxid::Context) {
