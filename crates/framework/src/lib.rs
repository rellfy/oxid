...
//! * Single command deploy for both WASM and Android [build instructions](https://github.com/not-fl3/oxid/#building-examples)
//! # Example
//! ```
...
impl EventHandlerFree for Stage {
    ...
    fn update(&mut self) {
        ...
        {
            // TODO: consider making it a part of oxid?
