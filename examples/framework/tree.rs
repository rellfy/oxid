...
fn tree(gl: &mut QuadGl, time: f64, deep: u32, angle: f32, tall: f32) {
    ...
    // we can use normal oxid_framework drawing API here
    draw_rectangle(-0.01 / 2., 0., 0.01, tall, RED);

    // and we can also modify internal oxid_framework render state with "gl" reference
