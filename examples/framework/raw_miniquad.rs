...
async fn main() {
    ...
    loop {
...

        {
            ...
            // Ensure that oxid_framework's shapes are not goint to be lost
            gl.flush();
            ...
            gl.quad_context
                .begin_default_pass(oxid::PassAction::Nothing);
