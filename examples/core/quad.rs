...
impl Stage {
    pub fn new(ctx: &mut Context) -> Stage {
        ...
        let pixels: [u8; 4 * 4 * 4] = [
            ...
            0x00, 0xFF, // 2nd bottom-most row.
            0xFF, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0xFF, 0xFF, 0xFF,
            0xFF, 0xFF, // 2nd top-most row.
            0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00,
            0x00, 0xFF, // Top row.
            0xFF, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0xFF, 0xFF, 0xFF,
            0xFF, 0xFF,
...
fn main() {
    oxid::start(conf::Conf::default(), |mut ctx| {
